...
<% ArrayList<PostBean> postList =(ArrayList<PostBean>)request.getAttribute("post_list"); %>
 ...
 <div class="container">
        ...
        <div class="interazione">
          <div class="delete-post">
            <ul class="inline-popups">
              <a href="#test-popupcan<%=i %>" data-effect="mfp-zoom-in"><img src="png/cancel.png" width="24px" height="24px"></a>
            </ul>
  ...
  <div id="test-popupcan<%=i %>" class="white-popup mfp-with-anim mfp-hide">
        <p>
          Sei sicuro di volere eliminare la foto?
        </p>
        <a href="RimuoviPost?idPost=<%=postList.get(i).getIdPost()%>"><button>Si</button></a>
