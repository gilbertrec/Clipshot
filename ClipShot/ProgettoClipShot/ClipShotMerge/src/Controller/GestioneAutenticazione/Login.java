	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (cookie!=null) {
			...
			if ((idUtente!=null)&&(password!=null)) {
				 ...
				 System.out.println("UtentePreLogin"+idUtente);
				 ...
				 try {
					...
					UtenteBean u_App= (UtenteBean)session.getAttribute("utente");
					System.out.println("UtenteinSessione"+u_session.getIdUtente());
