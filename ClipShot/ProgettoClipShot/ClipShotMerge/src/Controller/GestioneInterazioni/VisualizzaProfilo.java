	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ssn != null) {
			...
			if(idUtente != null) {
				...
				String idUtenteRicercato =(String)request.getParameter("idUtente");
				System.out.println("Get:"+request.getParameter("idUtente"));
					...
					try {
						...
						if(utenteBean.getIdUtente().equals(idUtente)) {
							...
							if (idUtente!=null) {
								...
								try {
									listaPost=postDAO.doRetrievePostByIdUtente(idUtenteRicercato);
