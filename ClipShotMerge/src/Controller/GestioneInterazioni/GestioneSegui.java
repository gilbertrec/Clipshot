...
@WebServlet("/GestioneSegui")

public class GestioneSegui extends HttpServlet{
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (utenteBean!=null) {
			...
			try {
				...
				if (seguiBean==null) {
					RequestDispatcher dispatcher=request.getRequestDispatcher("/AggiungiSegui");
					request.setAttribute("idFollower", idFollower);
					request.setAttribute("idFollowing", idFollowing);
					request.setAttribute("jspChiamante", jspChiamante);
					dispatcher.forward(request, response);
				}
				else {
					RequestDispatcher dispatcher=request.getRequestDispatcher("/RimuoviSegui");
					request.setAttribute("idFollower", idFollower);
					request.setAttribute("idFollowing", idFollowing);
					request.setAttribute("jspChiamante", jspChiamante);
					dispatcher.forward(request, response);
